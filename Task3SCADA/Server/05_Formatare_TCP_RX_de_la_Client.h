...
int receptie_de_la_client(char receiveBuf[256],int  dataSize )
{
	...
	Constante(server_Te);
		...
		PlotLine (g_hmainPanel, MAINPNL_GRAPH, tk_1, yITk3_1, tk, yITk3, VAL_BLACK);
				PlotLine (g_hmainPanel, MAINPNL_GRAPH_2, tk_1, yPIDk_1, tk, yPIDk, VAL_BLUE);
