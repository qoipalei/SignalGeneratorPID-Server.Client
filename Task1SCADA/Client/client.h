...
#define  MAINPNL_TE                       14      /* control type: numeric, callback function: transmisie_catre_server */
#define  MAINPNL_REFERINTA                15      /* control type: scale, callback function: transmisie_catre_server */
...
int  CVICALLBACK transmisie_catre_server(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
