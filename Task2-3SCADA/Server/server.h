...
#define  MAINPNL_CLEARBUTTON              19      /* control type: command, callback function: ClearCallback */
#define  MAINPNL_QUITBUTTON               20      /* control type: command, callback function: QuitCallback */
