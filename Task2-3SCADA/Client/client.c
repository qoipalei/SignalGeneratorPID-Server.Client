...
int main (int argc, char *argv[])
{
	...
	// Setarea valoarea default a portului la 10000 in cazul in care nu este introdus nimic
    portNum = strlen(portNumStr) == 0? 10000 : atoi (portNumStr);
	...
	switch (event) {
		...
		case EVENT_TIMER_TICK:
			...
			if (var_A_M == AUTOMAT){
				...
				// Generaza comanda
				GenerareComanda(Kr, Ti, Td, client_Te);
