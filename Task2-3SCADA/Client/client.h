...
#define  MAINPNL_TD                       14      /* control type: numeric, callback function: (none) */
#define  MAINPNL_KR                       15      /* control type: numeric, callback function: (none) */
#define  MAINPNL_TI                       16      /* control type: numeric, callback function: (none) */
